    ...
    const getStatistic = () => {
      axios.get('/ebook-snapshot/get-statistic').then((response) => {
        ...
        if (data.success) {
          ...
          //Resp后的属性是后端字段，statistic.value里的字段是前端字段
          // console.log("What is in resp[0]: ",statisticResp[0]);
          // console.log("What is in resp[1]: ",statisticResp[1]);
          ...
          // todayViewIncreaseRate：今日预计增长率（有正有负）
